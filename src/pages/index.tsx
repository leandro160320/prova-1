...
const sans = Source_Sans_3({ subsets: ['latin'], weight: ["300", "400", '700'] })

export default function Home() {
  return <div className={` bg-white text-black min-h-screen md:px-24 ${sans.className} font-normal md:font-light max-w-[1440px]`}>
    <main>
      ...
      <section className='text-center'>
        <h2 className='mb-4 text-4xl'>Ipsum sed consequat</h2>
        ...
        <div className='grid md:grid-cols-2 xl:grid-cols-3 divide-x-2 divide-y-2 border-r-2 border-b-2 mx-4 md:mx-10'>
    ...
    <footer className='flex flex-col mx-auto justify-center items-center py-16 pb-10 md:py-32'>
      ...
      <p className='font-bold text-sm'>© Untitled. Design: <u>ALUNOS WEB.</u></p>
    </footer>
  </div>
}
